  ...
  return (
    <style dangerouslySetInnerHTML={{ __html: `
      ...
      @font-face {
        ...
        src: url('${p}/fonts/HelveticaNeueThin.woff2') format('woff2');
        font-weight: 100;
        font-style: normal;
        font-display: swap;
        ascent-override: 95%;
      ...
      @font-face {
        font-family: 'Helvetica Neue';
        src: url('${p}/fonts/HelveticaNeueUltraLight.woff2') format('woff2');
        font-weight: 200;
        font-style: normal;
        font-display: swap;
        ascent-override: 95%;
      ...
      @font-face {
        font-family: 'Helvetica Neue';
        src: url('${p}/fonts/HelveticaNeueHeavy.woff2') format('woff2');
        font-weight: 800;
        font-style: normal;
        font-display: swap;
        ascent-override: 95%;
      ...
      @font-face {
        font-family: 'Helvetica Neue';
        src: url('${p}/fonts/HelveticaNeueBlack.woff2') format('woff2');
        font-weight: 900;
        font-style: normal;
        font-display: swap;
        ascent-override: 95%;
