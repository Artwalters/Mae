    ...
    <div ref={containerRef} className={styles.container}>
      ...
      <div className={styles.bottomBar}>
        ...
        <div className={styles.bottomBarSocials}>
          <a href="https://www.instagram.com/m.a.e._moveadaptevolve/" target="_blank" rel="noopener noreferrer" className={styles.bottomBarSocialLink}>
          ...
          <a href="https://www.tiktok.com/@mae_moveadaptevolve" target="_blank" rel="noopener noreferrer" className={styles.bottomBarSocialLink}>
